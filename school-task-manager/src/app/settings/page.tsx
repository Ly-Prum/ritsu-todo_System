                  ...
                  <>
                    <div style={{ display: 'flex', gap: 5, flexWrap: 'wrap' }}>
                      {SUBJECT_COLORS.map(c => (
                        <button key={c} onClick={() => setEditSubject(e => e ? { ...e, color: c } : e)} style={{ width: 18, height: 18, borderRadius: '50%', background: c, border: editSubject.color === c ? '2px solid white' : '1px solid transparent', cursor: 'pointer' }} />
                      ))}
                    </div>
