...
import { BookOpen, CheckCircle2, Users, GraduationCap, Pencil, Check, X, ChevronDown } from 'lucide-react'
...
export default function ProgressPage() {
  const { subjects, tasks, updateSubject } = useStore()
          ...
          return (
            <div key={sub.id} className="card" style={{
              ...
              <div
                ...
                style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '10px 14px', cursor: isEditing ? 'default' : 'pointer', userSelect: 'none' }}
              >
              ...
              <ProgressBar value={overallPct} color={oc} />
                ...
                <div style={{ padding: '10px 14px' }}>
                  ...
                  {(sub.credits || sub.hasExam || overallPct >= 100) && (
                    <div style={{ display: 'flex', gap: 6, marginTop: 8, flexWrap: 'wrap' }}>
                      ...
                      {sub.hasExam && (
                        <span style={{ fontSize: 10, padding: '2px 7px', borderRadius: 9999, background: '#ef444415', color: '#ef4444', border: '1px solid #ef444330' }}>
                          試験あり
                        </span>
                      )}
                      {overallPct >= 100 && (
